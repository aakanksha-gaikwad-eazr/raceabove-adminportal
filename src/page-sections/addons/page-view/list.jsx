...
export default function AddOnsListPageView() {
  ...
  return <div className="pt-2 pb-4">
    <HeadingArea/>
      <ListWrapper>
        ...
        <Button variant="contained" startIcon={<Add />} onClick={() => navigate('/add-ons/create-add-ons')}>
          Add Product
        </Button>
      </ListWrapper>
        ...
        <TableContainer>
          <Scrollbar>
            ...
            minWidth: 820
              ...
              <TableBody>
                {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(product => <ProductTableRow key={product.id} product={product} handleSelectRow={handleSelectRow} isSelected={isSelected(product.id)} handleDeleteProduct={handleDeleteProduct} handleEditProduct={handleEditProduct} />)}
