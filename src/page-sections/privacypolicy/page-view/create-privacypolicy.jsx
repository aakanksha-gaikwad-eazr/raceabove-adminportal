...
import { createPrivacyPolicies } from "@/store/apps/privacypolicy";
export default function CreatePrivacyPolicyPageView() {
  const DATA = [
  ...
  return (
    <Box py={3}>
      ...
      >
        <H6 fontSize={18}>Create Privacy Policy</H6>
          ...
          <Grid container spacing={3}>
            ...
            <Grid size={12}>
              <FlexBox alignItems="center" gap={2}>
                ...
                <Button variant="outlined" color="secondary" onClick={()=>navigate('/privacypolicy/ppage')}>
                  Cancel
                </Button>
              </FlexBox>
            </Grid>
