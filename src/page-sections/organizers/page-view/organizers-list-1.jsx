...
import UserTableRow from '../OrganizersTableRow';
import UserTableHead from '../OrganizersTableHead'; // CUSTOM DEFINED HOOK
...
export default function OrganizersList1PageView() {
