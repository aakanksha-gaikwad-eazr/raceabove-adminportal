...
export const getFaq = createAsyncThunk(
  ...
  async () => {
    try {
      ...
      throw new Error(
        "Failed to fetch all the frequently-asked-questions"
      );
    }
  }
);
...
//Review the FAQ
export const reviewFaq = createAsyncThunk(
  "appFaqSlice/reviewFaq",
  async (req) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData.accessToken;
      ...
      throw new Error(
        "Failed to review frequently-asked-questions details"
      );
    }
  }
);
...
export const getSingleFaq = createAsyncThunk(
  ...
  async (id) => {
    try {
      ...
      console.log(
        "single frequently-asked-questions data",
        response.data
      );
      ...
      throw new Error(
        "Failed to single frequently-asked-questions data"
      );
    }
  }
);
