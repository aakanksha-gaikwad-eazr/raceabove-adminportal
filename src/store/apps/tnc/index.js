...
export const reviewTnc = createAsyncThunk(
  "appTncSlice/reviewTnc",
  async (req) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData.accessToken;
      ...
      console.log(
        "reviewed Terms and conditions data",
        response.data
      );
...
export const getSingleTnc = createAsyncThunk(
  "appTncSlice/getSingleTnc",
  async (id) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData.accessToken;
