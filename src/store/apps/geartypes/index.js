...
//** fetch all sports
export const getGearTypes = createAsyncThunk('appSports/gearTypes', async () => {
  try {
...
//fetch sports by id
export const getGearTypesById = createAsyncThunk('appSports/getGearTypesById', async () => {
  try {
    const adminData = JSON.parse(localStorage.getItem('raceabove'))
    const accessToken = adminData.accessToken
...
//add sports
export const createGearTypes = createAsyncThunk('appUsers/createGearTypes', async (data) => {
...
export const deleteGearTypes = createAsyncThunk('appUsers/deleteGearTypes', async id => {
  try {
    const adminData = JSON.parse(localStorage.getItem('raceabove'))
    const accessToken = adminData.accessToken
