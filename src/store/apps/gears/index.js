...
export const getGearsById = createAsyncThunk(
  "appGears/getGearsById",
  async (id) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData.accessToken;
...
//add user
export const createGears = createAsyncThunk(
  "appGears/createGears",
  async (formData) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData?.accessToken;
...
export const deleteGears = createAsyncThunk(
  "appGears/deleteGears",
  async (id) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData.accessToken;
...
//update the user
export const updateGears = createAsyncThunk(
  "appGears/updateGears",
  async (req) => {
    try {
      const adminData = JSON.parse(localStorage.getItem("raceabove"));
      const accessToken = adminData.accessToken;
